...
struct CNode {
    ...
    std::shared_ptr<CStructItem> struct_item;    // Only in MOP_STRUCT_ITEM and MOP_STRUCT_ITEM_POINTER
    ...
    std::shared_ptr<CConstString> const_string;  // Only in CONST_STRING
    std::shared_ptr<CVariable> variable;         // Only in DECLARE_VARIABLE, LOAD_VARIABLE, FUNCTION_CALL*
    bool extern_flag{};                          // Only in DECLARE_VARIABLE
    CIncludeAttribute include_attribute;         // Only in DECLARE_VARIABLE
