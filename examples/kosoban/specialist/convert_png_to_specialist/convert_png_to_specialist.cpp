...
int main(int argc, char **argv) {
    try {
        ...
        for (const auto &f : files) {
            std::cout << "Process file " << f.string() << std::endl;
            std::string fileName = f.stem();
            ...
            if (algorithm == "mono") {
                ConvertImage(f, id, cw, ch, false, false);
            } else if (algorithm == "color") {
                ConvertImage(f, id, cw, ch, true, false);
            } else if (algorithm == "screen") {
                ConvertImage(f, id, cw, ch, true, true);
            } else {
