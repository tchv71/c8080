...
static const uint8_t COLOR_INK_BLACK = 1;
static const uint8_t COLOR_INK_BLUE = 4;
static const uint8_t COLOR_INK_GREEN = 2;
static const uint8_t COLOR_INK_RED = 6;
static const uint8_t COLOR_INK_CYAN = 7;
static const uint8_t COLOR_INK_MAGENTA = 13;
static const uint8_t COLOR_INK_YELLOW = 10;
static const uint8_t COLOR_INK_WHITE = 14;  // 15;
static const uint8_t COLOR_INK_GRAY = 14;
static const uint8_t COLOR_INK_LIGHT_BLUE = 5;
static const uint8_t COLOR_INK_LIGHT_RED = 9;
static const uint8_t COLOR_INK_LIGHT_CYAN = COLOR_INK_CYAN;
static const uint8_t COLOR_INK_LIGHT_GREEN = 3;
static const uint8_t COLOR_INK_LIGHT_MAGENTA = COLOR_INK_MAGENTA;
static const uint8_t COLOR_INK_LIGHT_YELLOW = 11;
static const uint8_t COLOR_INK_LIGHT_WHITE = 15;  // COLOR_INK_WHITE;
